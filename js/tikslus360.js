...
start_auto_rotate();
view360.find(".autorotate").text("Arreter la rotation automatique");
}
...
start_auto_rotate();
$(this).text("Arreter la Rotation Automatique");
}
else{
stop_auto_rotate();
$(this).text("Rotation automatique");
}
});
